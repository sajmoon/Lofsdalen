Ext.define('Lofsdalen.utils.Functions', {
    singleton: true,
	...
	See Lofsdalen.utils.Functions.getWeather(city + " " + country);. 
	...
	getCurrentLocation: function() {
		...
		Ext.device.Geolocation.getCurrentPosition({
			...
			success: function(position) {
				...
				//console.log(place);
				Lofsdalen.utils.Functions.getWeather(place);
				Ext.Viewport.unmask();
			},
			failure: function() {
				Ext.Viewport.unmask();
	...
	*/
	getWeather: function(place) {
		Ext.data.JsonP.request({
			...
			params: {
				key: Lofsdalen.utils.Functions.API_KEY,
				q: place,
				format: 'json',
				num_of_days: 1
			},
