Ext.define('Lofsdalen.store.Venue', {
  ...
  config: {
    ...
    data: [
      { name: "Trapper", headerimages: ['http://www.burgerbusiness.com/wp-content/uploads/Hardees_MemphisBBQ1.jpg'], shortDesc: "Hejsan. Lorem ipsum.. Weeee", categories: [ {url: "http://static.miniclipcdn.com/images/awards/store/1183_50.png"}, {url: "http://emoji.fileformat.info/gemoji/beer.png"} ] },
